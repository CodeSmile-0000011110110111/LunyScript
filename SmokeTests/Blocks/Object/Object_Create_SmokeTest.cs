...
public class Object_Create_SmokeTest : Script
{
	public override void Build(ScriptBuildContext context)
	{
		...
		On.Ready(Object.Create("Object.Create").From(prefabPath).Position(1, 3, -1).Rotation(45, 45, 45).Scale(.25, 4, 2).Parent(parentName));
		// alias:
		On.Ready(Prefab.Instantiate("Prefab.Instantiate")
			.From(prefabPath)
			.Position(1, 3, -1)
			.Rotation(-45, -45, -45)
			.Scale(.5, 6, 2)
