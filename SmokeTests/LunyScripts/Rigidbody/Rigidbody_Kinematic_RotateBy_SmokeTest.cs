...
{
	public override void Build(ScriptBuildContext context) => On.Heartbeat(Rigidbody.Kinematic.RotateBy(GVar["direction"] * 10, LunyAxis.X));
}

public class Rigidbody_RotateAxisY_SmokeTest : Script
{
	public override void Build(ScriptBuildContext context) => On.Heartbeat(Rigidbody.Kinematic.RotateBy(GVar["direction"] * 10, LunyAxis.Y));
}

public class Rigidbody_RotateAxisZ_SmokeTest : Script
{
	public override void Build(ScriptBuildContext context) => On.Heartbeat(Rigidbody.Kinematic.RotateBy(GVar["direction"] * -10, LunyAxis.Z));
}
...
{
	public override void Build(ScriptBuildContext context) => On.Heartbeat(Rigidbody.Kinematic.RotateBy(new LunyVector3(0, 12, 0)));
}
