...
namespace LunyScript
{
	...
	public sealed class ScriptVariables
	{
		...
		{
			get => ScriptVariableBlock.Create(_table.GetHandle(name));
		...
		/// <returns></returns>
		public ScriptVariableBlock Define(String name) => ScriptVariableBlock.Create(_table.DefineVariable(name, 0.0));
		/// <summary>
