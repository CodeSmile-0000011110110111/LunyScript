...
namespace LunyScript
{
	...
	internal sealed class ScriptEventScheduler
	{
		...
		internal ISequenceBlock ScheduleObjectEventSequence(ActionBlock[] blocks, LunyObjectEvent objectEvent, LunyStackTrace trace = null)
		{
		...
		internal ISequenceBlock ScheduleSceneEventSequence(ActionBlock[] blocks, LunySceneEvent sceneEvent, LunyStackTrace trace = null)
		{
			var sequence = SequenceBlock.TryCreate(blocks, trace);
			if (sequence == null)
				return sequence;
