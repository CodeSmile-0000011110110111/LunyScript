...
namespace LunyScript.Blocks
{
	...
	public abstract class VariableBlock : ConditionBlock
	{
		...
		public static implicit operator VariableBlock(Luny.Variable value) =>
		...
		public static VariableArithmeticBlock operator +(VariableBlock left, Luny.Variable right) => VariableAddBlock.Create(left,
		...
		public static VariableArithmeticBlock operator +(Luny.Variable left, VariableBlock right) => VariableAddBlock.Create(
			LiteralVariableBlock.Create(left, LunyScript.Trace.TryCreateStackTrace("+")), right, LunyScript.Trace.TryCreateStackTrace("+"));

		public static VariableArithmeticBlock operator -(VariableBlock left, Luny.Variable right) => VariableSubtractBlock.Create(left,
			LiteralVariableBlock.Create(right, LunyScript.Trace.TryCreateStackTrace("-")), LunyScript.Trace.TryCreateStackTrace("-"));

		public static VariableArithmeticBlock operator -(VariableBlock left, VariableBlock right) =>
			VariableSubtractBlock.Create(left, right, LunyScript.Trace.TryCreateStackTrace("-"));

		public static VariableArithmeticBlock operator -(Luny.Variable left, VariableBlock right) => VariableSubtractBlock.Create(
			LiteralVariableBlock.Create(left, LunyScript.Trace.TryCreateStackTrace("-")), right, LunyScript.Trace.TryCreateStackTrace("-"));

		public static VariableArithmeticBlock operator *(VariableBlock left, Luny.Variable right) => VariableMultiplyBlock.Create(left,
			LiteralVariableBlock.Create(right, LunyScript.Trace.TryCreateStackTrace("*")), LunyScript.Trace.TryCreateStackTrace("*"));

		public static VariableArithmeticBlock operator *(VariableBlock left, VariableBlock right) =>
			VariableMultiplyBlock.Create(left, right, LunyScript.Trace.TryCreateStackTrace("*"));

		public static VariableArithmeticBlock operator *(Luny.Variable left, VariableBlock right) => VariableMultiplyBlock.Create(
			LiteralVariableBlock.Create(left, LunyScript.Trace.TryCreateStackTrace("*")), right, LunyScript.Trace.TryCreateStackTrace("*"));

		public static VariableArithmeticBlock operator /(VariableBlock left, Luny.Variable right) => VariableDivideBlock.Create(left,
			LiteralVariableBlock.Create(right, LunyScript.Trace.TryCreateStackTrace("/")), LunyScript.Trace.TryCreateStackTrace("/"));

		public static VariableArithmeticBlock operator /(VariableBlock left, VariableBlock right) =>
			VariableDivideBlock.Create(left, right, LunyScript.Trace.TryCreateStackTrace("/"));

		public static VariableArithmeticBlock operator /(Luny.Variable left, VariableBlock right) => VariableDivideBlock.Create(
			LiteralVariableBlock.Create(left, LunyScript.Trace.TryCreateStackTrace("/")), right, LunyScript.Trace.TryCreateStackTrace("/"));
		...
		public static VariableBlock operator ==(VariableBlock left, Luny.Variable right) => left is null
		...
		public static VariableBlock operator >(VariableBlock left, Luny.Variable right) => VariableIsGreaterThanBlock.Create(left,
			LiteralVariableBlock.Create(right, LunyScript.Trace.TryCreateStackTrace(">")), LunyScript.Trace.TryCreateStackTrace(">"));
		...
		public static VariableBlock operator >=(VariableBlock left, Luny.Variable right) => VariableIsAtLeastBlock.Create(left,
			LiteralVariableBlock.Create(right, LunyScript.Trace.TryCreateStackTrace(">=")), LunyScript.Trace.TryCreateStackTrace(">="));

		public static VariableBlock operator >=(VariableBlock left, VariableBlock right) =>
			VariableIsAtLeastBlock.Create(left, right, LunyScript.Trace.TryCreateStackTrace(">="));

		public static VariableBlock operator <(VariableBlock left, Luny.Variable right) => VariableIsLessThanBlock.Create(left,
			LiteralVariableBlock.Create(right, LunyScript.Trace.TryCreateStackTrace("<")), LunyScript.Trace.TryCreateStackTrace("<"));

		public static VariableBlock operator <(VariableBlock left, VariableBlock right) =>
			VariableIsLessThanBlock.Create(left, right, LunyScript.Trace.TryCreateStackTrace("<"));

		public static VariableBlock operator <=(VariableBlock left, Luny.Variable right) => VariableIsAtMostBlock.Create(left,
			LiteralVariableBlock.Create(right, LunyScript.Trace.TryCreateStackTrace("<=")), LunyScript.Trace.TryCreateStackTrace("<="));
		...
		internal abstract Luny.Variable Variable { get; }
		...
		public ActionBlock Set(Luny.Variable value) => VariableSetValueBlock.Create(VarHandle,
		...
		private ActionBlock Set(Luny.Variable value, StackTrace trace) => VariableSetValueBlock.Create(VarHandle,
		...
		public ActionBlock Add(Luny.Variable value) => Set(this + value, LunyScript.Trace.TryCreateStackTrace(nameof(Add)));
		public ActionBlock Add(VariableBlock value) => Set(this + value, LunyScript.Trace.TryCreateStackTrace(nameof(Add)));
		public ActionBlock Sub(Luny.Variable value) => Set(this - value, LunyScript.Trace.TryCreateStackTrace(nameof(Sub)));
		public ActionBlock Sub(VariableBlock value) => Set(this - value, LunyScript.Trace.TryCreateStackTrace(nameof(Sub)));
		public ActionBlock Mul(Luny.Variable value) => Set(this * value, LunyScript.Trace.TryCreateStackTrace(nameof(Mul)));
		public ActionBlock Mul(VariableBlock value) => Set(this * value, LunyScript.Trace.TryCreateStackTrace(nameof(Mul)));
		public ActionBlock Div(Luny.Variable value) => Set(this / value, LunyScript.Trace.TryCreateStackTrace(nameof(Div)));
