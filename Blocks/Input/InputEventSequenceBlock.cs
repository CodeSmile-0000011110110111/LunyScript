...
namespace LunyScript.Blocks.PhysicsEvent
{
	...
	/// </summary>
	internal sealed class InputEventSequenceBlock : ScriptActionBlock, ISequenceBlock
	{
		...
		public static InputEventSequenceBlock Create(String actionName, String userName, LunyInputActionPhase phase, ScriptActionBlock[] blocks) =>
			blocks == null || blocks.Length == 0 ? null : new InputEventSequenceBlock(actionName, userName, phase, blocks);

		private InputEventSequenceBlock(String actionName, String userName, LunyInputActionPhase phase, IReadOnlyList<ScriptActionBlock> blocks)
		{
