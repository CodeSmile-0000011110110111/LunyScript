...
namespace LunyScript.Blocks
{
	public sealed class TransformPositionSetAxisBlock : ActionBlock
	{
		...
		public static TransformPositionSetAxisBlock Create(LunyAxis axis, Double value, LunyTransformSpace space, StackTrace trace) =>
			new(axis, value, space, trace);

		private TransformPositionSetAxisBlock(LunyAxis axis, Double value, LunyTransformSpace space, StackTrace trace)
			: base(trace)
		{
			_axis = axis;
			_value = value;
