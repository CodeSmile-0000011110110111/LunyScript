...
namespace LunyScript
{
	public readonly struct WhenInputBuilder
	{
		...
		/// <returns></returns>
		public WhenInputActionBuilder Action(String actionName) => new(_script, _script.CreateBuilderToken(actionName, "When.Input.Action"),
			actionName, _trace.Add(nameof(Action)));
	}
}
